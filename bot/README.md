...
<h3>Zike Bot — Python Discord Bot + FastAPI Backend</h3>
...
This folder contains the Zike Discord bot built on `discord.py v2` alongside a `FastAPI` backend that powers the web dashboard. Everything runs from a single `python Zike.py` command.
...
2. Choose **Cloudflared**, name it (e.g. `zike-api`), save
